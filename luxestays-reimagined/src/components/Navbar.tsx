    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          <button className="text-xs font-medium text-white hover:text-gold-400 transition-colors uppercase tracking-widest">
            Login
          </button>
        ...
        >
          <div className="px-6 py-8 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
              <button className="text-left text-white/80 uppercase tracking-widest text-sm">Login</button>
