        ...
        <div className="min-h-screen flex bg-luxury-dark text-luxury-text selection:bg-luxury-gold selection:text-white">
                ...
                <div className="relative z-10 w-full max-w-lg px-12 flex flex-col justify-center h-full">
                    ...
                    <div>
                        ...
                        <h1 className="text-5xl md:text-6xl font-bold text-white mb-4 leading-tight">
                            Welcome back to <br />
                            <span className="text-luxury-blue font-serif italic">Excellence.</span>
                        </h1>
                        <p className="text-luxury-muted text-lg mt-6 max-w-md">
                            Unlock your world of personalized luxury and exclusive rewards across our global destinations.
                        </p>
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-[#11141D]">
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-10">
                        <h2 className="text-4xl font-bold text-white mb-2 font-sans tracking-tight">Create Account</h2>
                        <p className="text-luxury-muted text-sm">Please enter your details to register.</p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="flex items-center gap-3 py-2">
                            ...
                            />
                            <label htmlFor="terms" className="text-sm text-luxury-muted cursor-pointer select-none">
                                I agree to the <a href="#" className="text-white hover:text-luxury-blue transition-colors">Terms of Service</a> and <a href="#" className="text-white hover:text-luxury-blue transition-colors">Privacy Policy</a>
                            </label>
                        </div>
                    ...
                    <p className="mt-10 text-center text-sm text-luxury-muted">
                        ...
                        <Link to={loginUrl} className="text-[#D4AF37] hover:text-white font-bold transition-colors">
                            Log in to your suite
                        </Link>
                    </p>
